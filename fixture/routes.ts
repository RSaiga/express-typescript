...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { SearchBodyRecordsController } from './../src/controllers/body_records/search_body_records_controller'
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { SearchUserController } from './../src/controllers/users/search_user_controller'
...
const models: TsoaRoute.Models = {
  BodyRecord: {
    ...
    properties: {
      ...
      fat_rate: { dataType: 'double', required: true },
...
export function RegisterRoutes(app: Router) {
  ...
  app.get(
    '/body_records',
    ...fetchMiddlewares<RequestHandler>(SearchBodyRecordsController),
    ...fetchMiddlewares<RequestHandler>(SearchBodyRecordsController.prototype.get),

    function SearchBodyRecordsController_get(request: any, response: any, next: any) {
      const args = {}
      ...
      try {
        ...
        const controller = new SearchBodyRecordsController()
  ...
  app.get(
    '/users/:userId',
    ...fetchMiddlewares<RequestHandler>(SearchUserController),
    ...fetchMiddlewares<RequestHandler>(SearchUserController.prototype.get),

    function SearchUserController_get(request: any, response: any, next: any) {
      const args = {
